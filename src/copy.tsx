...
export const LIFE_SEASONS_PRODUCT = `I worked on the packaging design for one of LifeSeasons brands, ReCODE. These supplements are neurologist-developed developed, highly individualized formulas that target brain health. Two of the products Daily Essentials and Daily Balance can be taken individually, or combined into our Core Kit to be taken together.`;
export const LIFE_SEASONS_VIDEO = `Boostng our Amazon content was a top priority. Working with the Amazon team I created short videos under 30 seconds to add to each of our product listings. These are made to be informative about the product and ingredients while also capturing the customer's  atenton.`;
