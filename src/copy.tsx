...
export const SUPPLEMENTS_DESCRIPTION = `I have over 7 years' experience working with a variety of different brands to create supplement label and box designs. A lot of these brands were just geVng started on their business and needed labels, logos, Amazon content and more. Below are a few examples.`;
